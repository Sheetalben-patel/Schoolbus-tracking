...
public class Profile extends AppCompatActivity implements View.OnClickListener{
    ...
    ImageButton St_attendanc,St_ancmnt,St_tracklocation,St_realtimelocation;
    //TextView useremail;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        St_realtimelocation= (ImageButton) findViewById(R.id.St_anno);
        ...
        St_realtimelocation.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        if(v==St_realtimelocation){


            Uri gmmIntentUri = Uri.parse("geo:22.5267674, 72.9231469");
